...
def visualize_from_checkpoint(checkpoint_path: str, output_dir: str = 'visualizations'):
    ...
    plot_layer_magnitudes(outputs['intermediates'], os.path.join(output_dir, 'layer_magnitudes.png'))
    
    # 3. Signal vs noise separation (final layer)
    plot_signal_noise_separation(outputs['Z'], labels, os.path.join(output_dir, 'signal_noise_separation.png'))
