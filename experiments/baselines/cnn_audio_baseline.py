...
def parse_args():
    ...
    # Model args
    parser.add_argument(
        "--d_complex", type=int, default=32, help="Used as channel width multiplier"
    )
...
def train_epoch(model, dataloader, optimizer, device, epoch):
    ...
    return {"loss": total_loss / len(dataloader), "accuracy": 100.0 * correct / total}
